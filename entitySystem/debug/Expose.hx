...
class Expose {
	...
	macro public static function exposeFloat(object:Dynamic, attribute:String, displayName:String) {
		#if expose
		return macro {
			Expose.i.addFloat($object, $v{displayName}, function(o:Dynamic):String {
				return o.$attribute;
			}, function(o:Dynamic, value:String):Void {
	...
	macro public static function exposeString(object:Dynamic, attribute:String, displayName:String) {
		#if expose
		return macro {
			Expose.i.addString($object, $v{displayName}, function(o:Dynamic):String {
				return o.$attribute;
			}, function(o:Dynamic, value:String):Void {
				o.$attribute = value;
			});
	...
	macro public static function exposeInt(object:Dynamic, attribute:String, displayName:String) {
		#if expose
		return macro {
			Expose.i.addInt($object, $v{displayName}, function(o:Dynamic):String {
				return o.$attribute;
			}, function(o:Dynamic, value:String):Void {
	...
	macro public static function exposeBool(object:Dynamic, attribute:String, displayName:String) {
		#if expose
		return macro {
			Expose.i.addBool($object, $v{displayName}, function(o:Dynamic):String {
				return o.$attribute;
			}, function(o:Dynamic, value:String):Void {
